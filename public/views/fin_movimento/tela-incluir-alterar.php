        ...
        <div class ="col s12">
            <div class="row">
                <div class ="col s12 valign-wrapper">
                    <div class ="col s12">
                        <h5 class="light blue-grey-text text-darken-4" v-show="!snAlterar">Incluir movimento</h5>
                        <h5 class="light blue-grey-text text-darken-4" v-show="snAlterar">Alterar movimento</h5>
                    </div>
                </div>
            </div>
